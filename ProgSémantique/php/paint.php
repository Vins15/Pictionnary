    ...
    <script>
        ...
        window.onload = function() {
            ...
            var startDrawing = function(e) {
                ...
                context.arc(75, 75, e.x, e.y, Math.PI * 2);
                context.stroke();
                context.closePath()
                context.fill();
                isDrawing = true;
            ...
            var draw = function(e) {
                if(isDrawing) {
                    ...
                    var command;
                    command = {"command": "draw", "x": x,"y" : y, "color" : color}
                    drawingCommands.push(command);
                    // ici, dessinez un cercle de la bonne couleur, de la bonne taille, et au bon endroit.
                    context.beginPath();
                    context.fillStyle = e.color.toString();
...
<form name="tools" action="req_paint.php" method="post">
    ...
    <input type="range" id="size"  max="4" min="0" step="1">
